...
namespace Hazel {
   ...
   public:
      ...
      inline static std::shared_ptr<spdlog::logger>& GetCoreLogger() { return s_spdCoreLogger; }
      inline static std::shared_ptr<spdlog::logger>& GetClientLogger() { return s_spdClientLogger; }
