...
namespace Hazel {
   ...
   const std::vector<std::shared_ptr<Hazel::VertexBuffer>>& OpenGLVertexArray::GetVertexBuffers() const {
      return(m_vertexBuffers);
   }


   const std::shared_ptr<Hazel::IndexBuffer>& OpenGLVertexArray::GetIndexBuffer() const {
